...
const SCRIPT_PATHS: Record<WorkflowType, string> = {
  implement: ".claude/src/auto-dev/implement-workflow.js",
  "address-comments": ".claude/src/auto-dev/address-comments-workflow.js",
  review: ".claude/src/auto-dev/review-workflow.js",
  roadmap: ".claude/src/auto-dev/roadmap-workflow.js",
};
